    ...
    <div className="h-[calc(100vh-120px)] w-full flex overflow-hidden">
      <div className="w-[50%] bg-[#333333] flex items-center justify-center">
        <div className="w-full max-w-[600px] p-8">
          ...
          <div className="h-[300px] overflow-y-auto border rounded-md border-[#8EF3BF] p-4 text-sm leading-relaxed mb-6">
            <p>
              본 서비스는 POPcon이 제공하는 온라인 음악 감상 및 추천 콘텐츠
              플랫폼으로, 회원가입을 통해 다양한 기능을 이용하실 수 있습니다.
              <br />
              본 서비스를 이용함으로써 이용자는 본 약관에 동의하게 되며, 약관은
              관련 법령 및 회사의 정책에 따라 수시로 변경될 수 있습니다.
              <br />
              회사는 보다 나은 서비스 제공을 위해 사용자로부터 일부 정보(예:
              브라우저 유형, 접속 일시, 선호 콘텐츠 등)를 자동 수집하며, 수집된
              정보는 서비스 품질 개선, 맞춤형 콘텐츠 제공, 시스템 안정성 확보를
              위해서만 활용됩니다. 수집된 정보는 외부에 무단으로 공유되지
              않으며, 관계 법령에서 요구하는 경우를 제외하고는 제3자에게
              제공되지 않습니다.
              <br />
              이용자는 회사가 제공하는 서비스 내 콘텐츠를 비상업적 개인 용도
              이외의 목적으로 사용할 수 없으며, 무단 복제·배포 등의 행위는 관련
              법령에 의해 처벌받을 수 있습니다. 또한, 회사는 서비스의 운영,
              보안, 유지보수를 위한 범위 내에서 일부 기능 또는 콘텐츠를 사전
              예고 없이 변경하거나 종료할 수 있습니다. 본 서비스의 저작권,
              상표권 등 모든 지식재산권은 회사 또는 정당한 권리자에게 있으며,
              이를 침해할 경우 민형사상의 책임을 질 수 있습니다.
              <br />
              이용자는 서비스 이용과 관련하여 법령 및 본 약관을 준수해야 하며,
              위반 시 서비스 이용이 제한될 수 있습니다.
              <br />
              자세한 사항은 개인정보 처리방침 및 커뮤니티 운영 정책을 참고해
              주세요. 서비스 이용과 관련한 문의사항은 고객센터를 통해
              접수해주시기 바랍니다.
            </p>
          </div>
