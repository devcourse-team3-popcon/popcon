    ...
    <a href={url} target='_blank'>
      <div className='w-[140px] h-[285px] border-b border-[var(--white)] md:w-[320px] md:h-[580px]'>
        ...
        <div className='mt-2 md:mt-10 md:mb-4'>
          <p className='h-[30px] overflow-hidden w-[140px]md:w-[320px] md:truncate text-xs md:text-[26px] text-[var(--primary-300)] font-bold mb-2'>
            {title}
          </p>
          <p className='text-xs md:text-lg font-bold mb-1'>{artist}</p>
