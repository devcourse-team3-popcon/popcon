...
export default function UserListItem({
  ...
  return (
    <div
      className="flex justify-between w-[640px] p-[16px] border-b border-[color:var(--grey-300)] cursor-pointer hover:border-[color:var(--primary-300)] group"
      onClick={() => {
    ...
    >
      ...
      <div className="flex items-center">
        <p className="w-full text-[14px] text-[color:var(--grey-200)] truncate">
