...
<br><br><br><br>
<div align="center">
<img alt="image" width="50%"  src="https://github.com/user-attachments/assets/400c3962-8148-4e59-a95e-2824d850dc9b">
</div>
<br><br><br><br>
...
|                 [@parkjungyuxx]([https://github.com/klmhyeonwoo](https://github.com/parkjungyuxx))                 |                  [@hxe_zu](https://github.com/hxezu)                  |                    [@mjlee](https://github.com/mjlee38)                    |                     [@YooJung_K](https://github.com/best106yj)                     |                        [@mafornp](https://github.com/mafornp)

## 🔥 프로젝트 소개

<mark>좋아하는 노래를 공유하고, 내한 공연 정보를 확인하며, 내 감성에 맞는 플레이리스트를 만들 수 있는 음악 커뮤니티 서비스에요.</mark>
...
<mark> 🍿팝콘은 지루했던 음악 생활에 <br>팝콘처럼 톡톡 튀는 즐거움을 더해드립니다!</mark>
...
- 디자인 QA (컴포넌트의 여백, 타이포그래피, 반응형 레이아웃 등의 불일치 요소 일관성 있게 수정)
...
- 사용자 프로필 이미지 렌더링 및 외부 클릭 시 자동 닫힘 처리로 세심한 UX 구현
> 핵심 개발 포인트
